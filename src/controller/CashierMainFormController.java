...
public class CashierMainFormController {
    ...
    public void addToListOnAction(ActionEvent event) {
        ...
        double discount=(unitPrice * (discountOfOne / 100))*QtyOfCustomer;
        double total = (unitPrice * QtyOfCustomer)-discount;
...
//        window.setScene(new Scene(load));
        UILoader.SetUI(lblLogOUT ,"CashierForm");
    }

    public void changeToQtyOnAction(ActionEvent actionEvent) {
        txtQty.requestFocus();
    }
